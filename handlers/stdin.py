            ...
            if len(vals) == 6 and str.isdigit(vals[0]):
                ...
                if hasStart3:
                    if bitCount == 51:
                        ...
                        #byte0 = self.getByte(bits,0)
                        byte1 = self.getByte(bits,7)
                        byte2 = self.getByte(bits,15)
                        byte3 = self.getByte(bits,23)
                        byte4 = self.getByte(bits,31)
